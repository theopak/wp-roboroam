...
0}a=c.extend({link:null},a);i=a.direction=="left"?"scrollLeft":i;if(a.scrollElement){e=a.scrollElement;g=e[i]()}else e=c("html, body").firstScrollable();h[i]=f+g+a.offset;e.animate(h,{duration:a.speed,easing:a.easing,complete:function(){a.afterScroll&&c.isFunction(a.afterScroll)&&a.afterScroll.call(a.link,a)}})};c.smoothScroll.version="1.4";c.fn.smoothScroll.defaults={exclude:[],excludeWithin:[],offset:0,direction:"top",scrollElement:null,scrollTarget:null,afterScroll:null,easing:"swing",speed:400}})(jQuery);window.log=function(){log.history=log.history||[];log.history.push(arguments);if(this.console){arguments.callee=arguments.callee.caller;var a=[].slice.call(arguments);(typeof console.log==="object"?log.apply.call(console.log,console,a):console.log.apply(console,a))}};(function(e){function h(){}for(var g="assert,count,debug,dir,dirxml,error,exception,group,groupCollapsed,groupEnd,info,log,timeStamp,profile,profileEnd,time,timeEnd,trace,warn".split(","),f;f=g.pop();){e[f]=e[f]||h}})((function(){try{console.log();return window.console}catch(a){return window.console={}}})());var debugmode=false;$("#orbit").orbit({animation:"horizontal-push",animationSpeed:800,timer:true,advanceSpeed:4000,pauseOnHover:false,startClockOnMouseOut:false,startClockOnMouseOutAfter:1000,directionalNav:true,captions:true,captionAnimation:"fade",captionAnimationSpeed:800,bullets:false,bulletThumbs:false,});function prepareSubpage(){if(debugmode==true){alert("function prepareSubpage(); called")}$("header nav ul li.page_item a").click(function(){$("#main-wrapper").hide("drop",{direction:"down"},500)});$("#main nav a").pjax("#main #content");$("#main #content").bind("pjax:start",function(){$("#content-wrapper").hide("fade",500)}).bind("pjax:end",function(){$("#content-wrapper").show("drop",{direction:"right"},500)});$("#main nav a").click(function(){$("#main nav a.current").removeClass("current");$(this).addClass("current")});$("section .third").wrap('<span style="width: 100%; height: 130px; margin: 0 auto; background-color: #E4E4E4; border: 1px solid #CCC; " />')}$(document).ready(function(){if(debugmode==true){alert("document ready, main script.js loop started")}prepareSubpage()});